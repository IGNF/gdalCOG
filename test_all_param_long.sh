...
./script/gdal_COG.sh --input $INPUT_DIR --output $OUTPUT_DIR --projection $EPSG --filename $FILENAME --extension $EXTENSION --warp --multithread --resampling CUBIC --compression LZW --predictor YES
